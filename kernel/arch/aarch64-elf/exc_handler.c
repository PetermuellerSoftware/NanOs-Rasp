...
void exc_handler(unsigned long type, unsigned long esr, unsigned long elr, unsigned long spsr, unsigned long far)
{
    ...
    switch(esr>>26) {
        ...
        case 0b000011: uart_puts("Trapped MCR/MRC with coproc=1111"); break;
        case 0b000100: uart_puts("Trapped MCRR/MRRC with coproc=1111"); break;
        case 0b000101: uart_puts("Trapped MCR/MRC with coproc=1110"); break;
        case 0b000110: uart_puts("Trapped LDC/STC"); break;
        case 0b000111: uart_puts("Access to SVE"); break;
